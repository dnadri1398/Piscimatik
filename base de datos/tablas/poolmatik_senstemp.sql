...
--
-- Table structure for table `senstemp`
--

DROP TABLE IF EXISTS `senstemp`;
...
--
-- Dumping data for table `senstemp`
--

LOCK TABLES `senstemp` WRITE;
/*!40000 ALTER TABLE `senstemp` DISABLE KEYS */;
/*!40000 ALTER TABLE `senstemp` ENABLE KEYS */;
UNLOCK TABLES;
