...
--
-- Table structure for table `senscloro`
--

DROP TABLE IF EXISTS `senscloro`;
...
--
-- Dumping data for table `senscloro`
--

LOCK TABLES `senscloro` WRITE;
/*!40000 ALTER TABLE `senscloro` DISABLE KEYS */;
/*!40000 ALTER TABLE `senscloro` ENABLE KEYS */;
UNLOCK TABLES;
